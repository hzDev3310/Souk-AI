...
@section('content')
    ...
    <div class="py-32 text-center space-y-8 glass rounded-[60px] border border-border/40">
        ...
        <a href="/" class="inline-block px-12 py-5 bg-primary text-white rounded-full font-black text-xs uppercase tracking-[0.2em] shadow-2xl shadow-primary/20 hover:scale-105 transition-all">{{ __('website.favorites.browse') }}</a>
    </div>
    @endif
@endsection
