...
<body
    ...
    <div class="lg:hidden fixed bottom-4 left-4 right-4 z-50">
        <div
            class="bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl border border-gray-200 dark:border-gray-800 rounded-[28px] p-1.5 flex items-center justify-around shadow-lg shadow-gray-200/50 dark:shadow-gray-950/50">

            <!-- Home -->
            <a href="/"
                class="group flex flex-col items-center gap-1.5 px-3 py-1.5 rounded-xl transition-all duration-300 {{ request()->is('/') ? 'text-primary' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300' }}">
            ...
            <!-- Cart -->
            <a href="/cart"
                class="group flex flex-col items-center gap-1.5 px-3 py-1.5 rounded-xl transition-all duration-300 {{ request()->is('cart*') ? 'text-primary' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300' }}">
                <div class="relative">
                    ...
                    <span id="cart-count-mobile"
                        class="absolute -top-2 -right-3 bg-red-500 text-white text-[9px] font-bold min-w-[18px] h-4 px-1 rounded-full flex items-center justify-center border border-white dark:border-gray-900 shadow-sm {{ count(session()->get('cart', [])) > 0 ? '' : 'hidden' }}">
            ...
            <div class="relative -mt-8">
                <button id="open-mobile-search"
                    class="relative w-14 h-14 bg-gradient-to-br from-primary to-primary/80 rounded-2xl flex items-center justify-center text-white shadow-xl shadow-primary/40 dark:shadow-primary/20 active:scale-95 transition-all duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <a href="{{ route('public.orders') }}"
                class="group flex flex-col items-center gap-1.5 px-3 py-1.5 rounded-xl transition-all duration-300 {{ request()->is('orders*') ? 'text-primary' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300' }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            @auth
                <a href="{{ route('public.profile') }}"
                    class="group flex flex-col items-center gap-1.5 px-3 py-1.5 rounded-xl transition-all duration-300 {{ request()->is('profile*') ? 'text-primary' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300' }}">
                    <div
                        class="w-6 h-6 rounded-full bg-gradient-to-br from-primary/80 to-primary flex items-center justify-center text-white font-bold text-[10px] shadow-sm">
            ...
            @else
                <a href="/login"
                    class="group flex flex-col items-center gap-1.5 px-3 py-1.5 rounded-xl transition-all duration-300 {{ request()->is('login*') ? 'text-primary' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
